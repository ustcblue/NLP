...
class LSTMTheano:
    ...
    def __theano_build__(self):
        ...
        param_updates = self.adam(o_error, params)
        '''
        # Gradients
        ...
        self.sgd_step = theano.function([x,y,learning_rate], [], updates = param_updates) 
        '''
    ...
    '''
    def adam(self, loss, all_params, learning_rate=0.001, b1=0.9, b2=0.999, e=1e-8,
                 gamma=1-1e-8):
        """
        ADAM update rules
